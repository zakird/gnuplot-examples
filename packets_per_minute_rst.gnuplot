...
#set ylabel font ",20"
#set yrange [0:2000]
set title "packets per minute rst"
...
plot "packets_per_minute.csv.sorted" using 3 title "Georgia Tech RST" with lines ls 1, \
"packets_per_minute.csv.sorted" using 5 title "Michigan RST" with lines ls 4 ;