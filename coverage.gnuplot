...
plot 'allscans.csv' using ($1*100/5472256.0):2 with lines title "all scans" ls 2, \
'noport445.csv' using ($1*100/5472256.0):2 with lines title "port 445 excluded" ls 1;
...
set xrange [.5:100]
set ytics .001
plot 'allscans.csv' using ($1*100/5472256.0):($2) with lines notitle ls 2, \
'noport445.csv' using ($1*100/5472256.0):($2) with lines notitle ls 1;
