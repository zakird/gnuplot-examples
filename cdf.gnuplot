...
set xlabel "Organizations"
set ylabel "CDF of IP Addresses"
...
plot "umblacklist.cdf.csv" using 1:2 title "Excluded Organizations" with lines ls 4 , \
	 "missing.cdf.csv" using 1:2 title "Inaccessible Organizations" with lines ls 2;
